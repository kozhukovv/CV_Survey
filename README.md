# Обзор литературы по детекции различных объектов вокруг транспортного средства при движении

## Оглавление

- [Обзор литературы по детекции различных объектов вокруг транспортного средства при движении](#обзор-литературы-по-детекции-различных-объектов-вокруг-транспортного-средства-при-движении)
  - [Оглавление](#оглавление)
  - [Road damage detection (детекция дорожных дефектов)](#road-damage-detection-детекция-дорожных-дефектов)
  - [Litter detection (детекция мусора)](#litter-detection-детекция-мусора)
